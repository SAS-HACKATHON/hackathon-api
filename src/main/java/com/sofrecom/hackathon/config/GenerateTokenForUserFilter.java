...
import com.sofrecom.hackathon.model.SessionItem;
import com.sofrecom.hackathon.model.SessionResponse;
import com.sofrecom.hackathon.model.User;
import com.sofrecom.hackathon.security.*;
...
public class GenerateTokenForUserFilter extends AbstractAuthenticationProcessingFilter {
	 ...
	 static Logger LOGGER = LoggerFactory.getLogger(GenerateTokenForUserFilter.class);
